...
export const vi = {
  ...
  'actionDone.confirm': 'Đã xác nhận, cơ hội chuyển lên trưởng nhóm',
  'actionDone.view': 'Đã đánh dấu đã xem',
  'actionDone.send_back': 'Đã trả lại cho nhân viên',
  'actionDone.coach': 'Đã duyệt hướng xử lý',
  'actionDone.escalate': 'Đã chuyển giám đốc đơn vị',
  'actionDone.decide': 'Đã ghi quyết định, việc chuyển lại cho nhân viên',
  'actionDone.complete': 'Đã ghi nhận thành công',
  'actionDone.close': 'Đã đóng cơ hội',
  ...
  'actions.hint.send_back': 'Chưa rõ nguồn trả nợ thứ hai, cần bổ sung sao kê',
  'actions.hint.escalate': 'Khách đề nghị lãi suất dưới biểu, vượt thẩm quyền nhóm',
  'actions.hint.complete': 'Đã giải ngân, khách nhận tiền ngày 28/9',
  'actions.hint.close': 'Khách chọn ngân hàng khác vì lãi suất thấp hơn',
